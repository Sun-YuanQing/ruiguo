<template>
  ...
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.user_name" placeholder="用户名称" style="width: 20%;" class="filter-item" @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.user_account" placeholder="用户账号" style="width: 20%;" class="filter-item" @keyup.enter.native="handleFilter" />
      ...
      <el-table-column label="状态" align="center" width="80">
        <template slot-scope="{ row }">
          <el-tooltip :content="row.status == 1 ? '启用' : '禁用'" placement="top">
            <el-switch @change="onUserStatus(row)" v-model="row.status" active-color="#7B68EE" inactive-color="#cccccc" :active-value="1" :inactive-value="2"></el-switch>
          </el-tooltip>
        </template>
      </el-table-column>
...
<div class="app">
 ...
 <el-pagination v-show="total > 0" style="margin-top: 1rem;"
      @size-change="onPageSizeChange"
      @current-change="onPageNumderChange"
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <el-form ref="formData" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 100%; margin-left:50px;">
        <el-form-item label="排序"    style="width:60%"><el-input v-model="temp.sort"/></el-form-item>
        <el-form-item label="用户名称" style="width:60%"><el-input v-model="temp.user_name" /></el-form-item>
        <el-form-item label="用户账号"  style="width:60%"><el-input v-model="temp.user_account" /></el-form-item>
        <el-form-item label="密码" style="width:60%"><el-input ref="password" v-model="temp.user_password" type="password" placeholder="请输入密码" name="password" /></el-form-item>
        <el-form-item label="状态">
           <el-tooltip :content="temp.status == 1 ? '启用' : '禁用'" placement="top">
             <el-switch @change="onUserStatus('temp')" v-model="temp.status" active-color="#7B68EE" inactive-color="#cccccc" :active-value="1" :inactive-value="2"></el-switch>
           </el-tooltip>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    getList() {
      var that = this;
      that.userlist={...that.userlist,...that.listQuery}
