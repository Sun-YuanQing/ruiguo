...
var ctrl_id = "c";
var func_id = "f";
var webroot = "http://www.hengjiansg.com/";
var apifile = "api.php";
var lang= new Array();

function get_url(ctrl,func,ext){var url = "http://www.hengjiansg.com/index.php?c="+ctrl;if(func){url+="&f="+func;};if(ext){url+="&"+ext};return url;}
function get_plugin_url(id,func,ext){var url = "http://www.hengjiansg.com/index.php?c=plugin&f=exec&id="+id+"&exec="+func;if(ext){url+="&"+ext};url+="&_noCache="+Math.random();return url;};
function api_url(ctrl,func,ext){var url = "http://www.hengjiansg.com/api.php?c="+ctrl;if(func){url+="&f="+func;};if(ext){url+="&"+ext};url+="&_noCache="+Math.random();return url;};
function api_plugin_url(id,func,ext){var url = "http://www.hengjiansg.com/api.php?c=plugin&f=index&id="+id+"&exec="+func;if(ext){url+="&"+ext};url+="&_noCache="+Math.random();return url;};
...
function mysoft_form_password(id,len)
{
...
//表单扩展按钮
//btn，类型
function mysoft_btn_action(btn,id)
{
	if(btn == "image")
	{
		if(!id || id == "undefined")
...
function mysoft_btn_view(btn,id)
{
	if(btn == "image")
	{
		var url = $("#"+id).val();
...
//清空
function mysoft_btn_clear(btn,id)
{
	$("#"+id).val("");
}

function _mysoft_form_opt(val,id,eid,etype)
{
...
function mysoft_btn_editor_picture(id)
{
...
function mysoft_btn_editor_file(id)
{
...
function mysoft_btn_editor_video(id)
{
...
//删除单个主题关联
function mysoft_title_delete_single(id)
{
	$("#"+id).val("");
	$("#title_"+id).hide();
	$("#mysoft-btn-"+id+"-delete").hide();
}

//删除多个主题关联
function mysoft_title_delete(id,val)
{
	if(val && val != "undefined")
	{
		//移除DIV值
	...
	{
		mysoft_title_delete(id,lst[i]);
	}
	return true;
}

//选择主题关联
function mysoft_title_select(project_id,is_multi,title,input)
{
...
function mysoft_user_delete(id,val)
{
	//移除DIV值
	$("#"+id+"_div_"+val).remove();
	//移除值
...
function mysoft_edit_type(id)
{
	...
	{
		$("#"+id).xheditor(false);
		eval("CodeMirror_MYSOFT_"+id+"()");
		$(t).val("可视化");
	}
}

function mysoft_form_upload_attr_cate_id()
{
...
{
	return $.mysoft.ajax(turl);
}

// 同步加载Ajax，返回JSON数组
function json_ajax(turl)
{
	return $.mysoft.json(turl);
}
